...
# Build a Planning Search Agent

![planningSearch](Progression.png)
...
You can also find my **Experiment Results** assignment and a **HeuristicAnalysis**, both in pdf format.
...
Once finished, you can run my personal version of this project
     ...
     (pmaienv)$ python run_search.py -m
       
You can manually select the kind of problem with increasing difficulty (1-3) and then from a list of different algorithms:
